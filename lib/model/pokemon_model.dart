...
PokemonModel pokemonModeFromJson(String str) =>
    PokemonModel.fromJson(json.decode(str));

String pokemonModeToJson(PokemonModel data) => json.encode(data.toJson());
...
// jsona çevirme, gelen veriden nesne üretir
  factory Evolution.fromJson(Map<String, dynamic> json) => Evolution(
        num: json["num"],
        name: json["name"],
      );
//post veya json.encode gibi işlemlerde kullanmak için
  Map<String, dynamic> toJson() => {
        "num": num,
        "name": name,
      };
